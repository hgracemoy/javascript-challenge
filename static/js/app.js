...
// 03-Evr_D3_Table
// looping through data / console.log each alien sighting report object
data.forEach(function(alienSighting) {
    console.log(alienSighting);
    // d3 to append one table row `tr` for each alien sighting report object
    var row = tbody.append("tr");
    // Object.entries to console.log each alien sighting report value
    Object.entries(alienSighting).forEach(function([key, value]) {
        console.log(key, value);
        // Append cell to row each value in the alien sighting report object
...
// D3 `.on` to attach a click handler
submit.on("click", function() {
    ...
    // Use form input to filter the data by blood type
